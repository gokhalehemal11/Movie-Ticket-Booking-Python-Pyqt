...
class dont_know3:
	...
	def nn_id( self , my_id , time):
		print "in seat2 id :" , my_id
		print "in seat2 time:" , time
		self.used_id = my_id
		self.used_time = time
...
class Ui_Form(object , dont_know3):
    ...
    def __init__(self):
	    ...
	    sql3 = " select seats from 3idiots_booking " 
	    cur.execute(sql3)

	    res = cur.fetchall()

	    self.already_booked_3idiots = [ i[0] for i in res]
	...
	print "already booked 3 idiots :" , self.already_booked_3idiots
...
#	print "gold :" , self.g
#	print "silver :" , self.s
	print "booked 3 idiots :" , self.booked
	booked_string_user = ' '.join(self.booked)
	#dk2 = dont_know2()  u dont have dk2 defined in this
	p1.g1.g(dk3.used_id, self.booked , dk3.used_time , '3_idiots',self.already_booked_3idiots)
