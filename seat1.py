...
class dont_know2:
	...
	def nn_id( self , my_id , time):
		print "in seat1 id :" , my_id
		print "in seat1 time:" , time
		self.used_id = my_id
		self.used_time = time
	

class Ui_Form(object , dont_know2):
    ...
    def __init__(self):
	    ...
	    sql3 = " select seats from J2CE_booking  " 
	    cur.execute(sql3)

	    res = cur.fetchall()

	    self.already_booked_J2CE = [ i[0] for i in res]
	...
	print " already booked J2CE :" , self.already_booked_J2CE
...
#	print "gold :" , self.g
#	print "silver :" , self.s
	print "booked J2CE :" , self.booked
	booked_string_user = ' '.join(self.booked)

	g1.g(dk2.used_id, self.booked , dk2.used_time , 'J2CE',self.already_booked_J2CE)
